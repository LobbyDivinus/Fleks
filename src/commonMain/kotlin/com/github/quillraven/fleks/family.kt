...
data class FamilyDefinition(
     ...
     */
    fun all(vararg types: TrackableType<*>): FamilyDefinition {
     ...
     */
    fun none(vararg types: TrackableType<*>): FamilyDefinition {
     ...
     */
    fun any(vararg types: TrackableType<*>): FamilyDefinition {
